(function webpackUniversalModuleDefinition(root,factory){
    if(typeof exports === 'object' && typeof module === 'object'){
        ...
        root["rt"] = root["rt"] || {},root["rt"]["colorPicker"] = factory();
    }
})(window,function(){
    ...
    ([
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var forEach = require('rt-code-snippet/collection/forEach'); // node,commonjs
             *
             * var sum = 0;
             *
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var inArray = require('rt-code-snippet/array/inArray'); // node,commonjs
             *
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @memberof module:collection
             * @example
             * var forEachArray = require('rt-code-snippet/collection/forEachArray'); // node,commonjs
             *
             * var sum = 0;
             *
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @memberof module:collection
             * @example
             * var forEachOwnProperties = require('rt-code-snippet/collection/forEachOwnProperties'); // node,commonjs
             *
             * var sum = 0;
             *
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var CustomEvents = require('rt-code-snippet/customEvents/customEvents'); // node,commonjs
             *
             * var model;
             * function Model(){
             *     this.name = '';
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var inherit = require('rt-code-snippet/inheritance/inherit'); // node,commonjs
             *
             * // Parent constructor
             * function Animal(leg){
             *     this.leg = leg;
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @memberof module:type
             * @example
             * var isExisty = require('rt-code-snippet/type/isExisty'); // node,commonjs
             *
             * isExisty(''); //true
             * isExisty(0); //true
             * isExisty([]); //true
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var browser = require('rt-code-snippet/browser/browser'); // node,commonjs
             *
            ...
            var svgvml = {
                ...
                setGradientColorStop: function(obj,colorStr){
                    if(isOldBrowser){
                        ...
                        obj.setAttribute('stopColor',colorStr);
                    }
                }
            };
        ...
        (function(module,exports,__webpack_require__){
             ...
             * To prevent hostname set rt.usageStatistics to false.
            ...
            function sendHostname(appName,trackingId){
                ...
                var applicationKeyForStorage = 'RT ' + appName + ' for ' + hostname + ': Statistics';
                var date = window.localStorage.getItem(applicationKeyForStorage);
                // skip if the flag is defined and is set to false explicitly
                if(!isUndefined(window.rt) && window.rt.usageStatistics === false){
                    return;
                }
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @example
             * var imagePing = require('rt-code-snippet/request/imagePing'); // node,commonjs
             *
        ...
        (function(module,exports,__webpack_require__){
             ...
             * @memberof module:collection
             * @example
             * var toArray = require('rt-code-snippet/collection/toArray'); // node,commonjs
             *
             * var arrayLike = {
             *     0: 'one',
             *     1: 'two',
        ...
        (function(module,exports,__webpack_require__){
            ...
            (function(global){
                ...
                var SVGSlider = ['<svg class="{{cssPrefix}}svg {{cssPrefix}}svg-slider">','<defs>','<linearGradient id="{{cssPrefix}}svg-fill-color-{{id}}" x1="0%" y1="0%" x2="100%" y2="0%">','<stop offset="0%" stopColor="rgb(255,255,255)" />','<stop class="{{cssPrefix}}slider-basecolor" offset="100%" stopColor="rgb(255,0,0)" />','</linearGradient>','<linearGradient id="{{cssPrefix}}svn-fill-black-{{id}}" x1="0%" y1="0%" x2="0%" y2="100%">','<stop offset="0%" style="stopColor:rgb(0,0,0);stop-opacity:0" />','<stop offset="100%" style="stopColor:rgb(0,0,0);stop-opacity:1" />','</linearGradient>','</defs>','<rect width="100%" height="100%" fill="url(#{{cssPrefix}}svg-fill-color-{{id}})"></rect>','<rect width="100%" height="100%" fill="url(#{{cssPrefix}}svn-fill-black-{{id}})"></rect>','<path transform="translate(0,0)" class="{{cssPrefix}}slider-handle" d="M0 7.5 L15 7.5 M7.5 15 L7.5 0 M2 7 a5.5 5.5 0 1 1 0 1 Z" stroke="black" stroke-width="0.75" fill="none" />','</svg>'].join('\n');
                ...
                var SVGHuebar = ['<svg class="{{cssPrefix}}svg {{cssPrefix}}svg-huebar">','<defs>','<linearGradient id="g-{{id}}" x1="0%" y1="0%" x2="0%" y2="100%">','<stop offset="0%" stopColor="rgb(255,0,0)" />','<stop offset="16.666%" stopColor="rgb(255,255,0)" />','<stop offset="33.333%" stopColor="rgb(0,255,0)" />','<stop offset="50%" stopColor="rgb(0,255,255)" />','<stop offset="66.666%" stopColor="rgb(0,0,255)" />','<stop offset="83.333%" stopColor="rgb(255,0,255)" />','<stop offset="100%" stopColor="rgb(255,0,0)" />','</linearGradient>','</defs>','<rect width="18px" height="100%" fill="url(#g-{{id}})"></rect>','<path transform="translate(-6,-3)" class="{{cssPrefix}}huebar-handle" d="M0 0 L4 4 L0 8 L0 0 Z" fill="black" stroke="none" />','</svg>'].join('\n');
